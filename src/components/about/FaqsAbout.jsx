...
const CategoryIcons = {
  "Web Development": (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="text-[#998542] h-6 w-6 opacity-70"
    >
...
const SkillsList = () => {
  ...
  const skills = {
    "What technologies do I use?": [
      "I work across the full stack with Python, JavaScript/TypeScript, React, Next.js, and Node.js. For data engineering, I use Azure, SQL, and various ML frameworks like PyTorch and TensorFlow. I'm also experienced with React Native for mobile development.",
    ],
    "My Experience": [
      "I've interned at Hexagon (data engineering), Shepherd Ventures (quantitative research), and Suntop Technology (software engineering). I also worked as a research assistant at Texas A&M's Innovation Lab, processing 1TB+ of weather data for ML models.",
    ],
    "My Education": [
      "I'm pursuing a B.S. in Computer Engineering at Texas A&M University (graduating May 2026). My coursework covers data structures, algorithms, machine learning, and distributed systems. I also learn continuously through personal projects and hackathons.",
    ],
    ...
    <div className="flex flex-col items-center text-left mx-auto max-w-6xl px-4">
      <div className="site-container mt-10">
        <h2 className="text-4xl font-bold flex flex-col items-center gap-6 text-center whitespace-nowrap text-white md:flex-row md:items-center md:text-end">
          <span className="hidden h-1 grow rounded-lg bg-gradient-to-r from-[#998542]/30 to-[#500000] md:block"></span>
          <span>More About <span className="text-[#998542]">Me</span></span>
        </h2>
          ...
          {Object.entries(skills).map(([category, items]) => (
            <li key={category} className="w-full">
              <div
                ...
                className="bg-[#12121a] border border-[#998542]/10 hover:border-[#998542]/30 w-full cursor-pointer overflow-hidden rounded-xl text-left transition-all"
              >
                <div className="flex items-center gap-3 p-4">
                  ...
                  <div className="flex grow items-center justify-between gap-2">
                    ...
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className={`h-6 w-6 shrink-0 transform text-[#998542] transition-transform ${
                ...
                >
                  <p className="text-[0.9em] text-zinc-400 leading-relaxed">{skills[category]}</p>
                </div>
              </div>
            </li>
          ))}
