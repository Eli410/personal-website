...
const CategoryIcons = {
  "Web Development": (
    <svg
      ...
      viewBox="0 0 24 24"
      fill="currentColor"
      className="text-[#38bdf8] h-6 w-6 opacity-70"
    >
    ...
    <div className="flex flex-col items-center text-left mx-auto max-w-6xl px-4">
      <div className="site-container mt-10">
        <h2 className="text-4xl font-bold flex flex-col items-center gap-6 text-center whitespace-nowrap text-white md:flex-row md:items-center md:text-end">
          <span className="hidden h-1 grow rounded-lg bg-gradient-to-r from-[#38bdf8]/30 to-[#1e293b] md:block"></span>
          <span>More About <span className="text-[#38bdf8]">Me</span></span>
        </h2>
          ...
          {Object.entries(skills).map(([category, items]) => (
            <li key={category} className="w-full">
              <div
                ...
                className="bg-[#1e293b] border border-[#38bdf8]/10 hover:border-[#38bdf8]/30 w-full cursor-pointer overflow-hidden rounded-xl text-left transition-all"
              >
                <div className="flex items-center gap-3 p-4">
                  ...
                  <div className="flex grow items-center justify-between gap-2">
                    ...
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      className={`h-6 w-6 shrink-0 transform text-[#38bdf8] transition-transform ${
